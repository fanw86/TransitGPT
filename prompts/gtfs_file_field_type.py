...
GTFS_FILE_FIELD_TYPE_MAPPING = {
    ...
    "stop_times.txt": {
        ...
        "start_pickup_drop_off_window": "time (seconds since midnight)",
        "end_pickup_drop_off_window": "time (seconds since midnight)",
        "pickup_type": "integer",
        "drop_off_type": "integer",
        "continuous_pickup": "integer",
        "continuous_drop_off": "integer",
        "shape_dist_traveled": "float (GTFS_DISTANCE_UNITS)",
        "timepoint": "integer",
    ...
    "booking_rules.txt": {
        ...
        "prior_notice_last_day": "date (datetime.date)",
        "prior_notice_last_time": "time (seconds since midnight)",
        "prior_notice_start_day": "date (datetime.date)",
        "prior_notice_start_time": "time (seconds since midnight)",
